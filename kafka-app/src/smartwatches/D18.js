    ...
    return <div>
      ...
      <section className="main">
        <section className="info1">
          <h2>{this.props.items[9].title}</h2>
          <p>RS {this.props.items[9].price}</p>
          
            <Link to="/cart" className="info-link" onClick={()=>{this.handleClick(this.props.items[9].id)}}>
              Add to bag
            </Link>
        ...
        <figure className="figure1">
          <img className="figure-img" src={Item10a} alt="headphones"/>
        </figure>

        
      
        <figure className="figure6">
          <img className="figure-img" src={Item10b} alt="headphones"/>
        </figure>
...
export default connect(mapStateToProps,mapDispatchToProps) (D18);